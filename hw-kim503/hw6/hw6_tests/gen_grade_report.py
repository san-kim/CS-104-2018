...
RUBRIC_COLORING = os.path.join(source_dir, 'rubric', 'coloring.config')
...
P1 = cs_grading.Problem(HOMEWORK, 1, 'search', 15)
P2 = cs_grading.Problem(HOMEWORK, 2, 'coloring', 25)
P4 = cs_grading.Problem(HOMEWORK, 4, 'heap', 25)

for problem, rubric in [(P1, RUBRIC_SEARCH), (P2, RUBRIC_COLORING), (P4, RUBRIC_HEAP)]:
